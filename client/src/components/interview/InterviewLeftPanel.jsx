...
class ComponentErrorBoundary extends React.Component {
    ...
    render() {
        if (this.state.hasError) return <div className="w-full h-full bg-white/5 animate-pulse rounded-lg" />;
...
const InterviewLeftPanel = ({
    ...
    return (
        <div className="w-[420px] border-r border-white/5 bg-[#08080a]/80 backdrop-blur-sm flex flex-col relative z-20 shadow-2xl">
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        <div className="space-y-2">
                            ...
                            <h2 className="text-lg font-light leading-relaxed text-white/90 font-sans tracking-tight">
                                {currentQuestion}
                            </h2>
                        </div>
                        <Button
            ...
            <div className="p-4 bg-[#0a0a0c] border-t border-white/5">
                <div className="w-full aspect-video rounded-xl bg-white/[0.02] border border-white/5 overflow-hidden relative shadow-inner">
                    <ComponentErrorBoundary>
                        <Suspense fallback={<div className="w-full h-full flex items-center justify-center bg-white/5 animate-pulse text-[10px] text-zinc-500 font-mono">LOADING CAMERA...</div>}>
                            <WebcamMonitor onEmotionDetect={() => { }} />
                        </Suspense>
                    </ComponentErrorBoundary>
                </div>
                <div className="flex items-center justify-between mt-3 px-1">
                    <div className="text-xs font-medium text-white/50">Live Emotion Analysis</div>
